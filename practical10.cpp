Question 10: Consider a scenario for Hospital to cater services to different kinds of
patients as Serious (top priority), b) 
2 non-serious (medium priority), c) General Checkup (Least priority). Implement the
...
} CLINICAL TOKEN MANAGEMENT SYSTEM-------------------------------------\n\n");
        printf("1.ADMISSION BASED ON PRIORITY\n\n");
        printf("2.REMOVE VISITED PATIENT\n\n");
        printf("3.DISPLAY THE LIST ALONG WITH THEIR PRIORITY\n\n");
        printf("4.EXIT.\n\n");
